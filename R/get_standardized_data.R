...
get_standardized_data_hourly <- function(iso,
  ...
  wh_dataset <- dplyr::case_when(iso == 'ercot' ~ 'ercot_standardized_hourly',
                                 iso == 'caiso' ~ 'caiso_standardized_hourly',
                                 iso == 'isone' ~ 'isone_standardized_hourly',
                                 iso == 'miso' ~ 'miso_standardized_hourly',
                                 iso == 'nyiso' ~ 'nyiso_standardized_hourly',
                                 iso == 'pjm' ~ 'pjm_standardized_hourly',
                                 iso == 'spp' ~ 'spp_standardized_hourly')
